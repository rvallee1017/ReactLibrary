                ...
                <div className="books">
                    <div className="row">
                            ...
                            <div className="cart__header">
                                ...
                                <div className="cart__body">
                                    ...
                                    <div className="cart__total">
                                        <span className="cart__total--amount">${((book.salePrice || book.originalPrice) * book.quantity).toFixed(2)}</span>
                                    </div>
                                </div>
                                            )
                                    })}
                        ...
                        {cart.length > 0 && (<div className="total">
                            ...
                            <button className="btn btn__checkout no-cursor" onClick={() => alert('Sorry, this is a demo. Checkout is not available.')}>
                                Proceed to Checkout
                            </button>
                        </div>
                    )}
