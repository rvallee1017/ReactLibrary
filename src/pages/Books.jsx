...
const Books = ({ books: initialBooks }) => {
    ...
    function filterBooks(filter) {
        if (filter === "LOW_TO_HIGH") {
            setBooks(books.slice((a, b) => (a.salePrice || a.originalPrice) - (b.salePrice || b.originalPrice)));
        }
        if (filter === "HIGH_TO_LOW") {
            setBooks(books.slice((a, b) => (b.salePrice || b.originalPrice) - (a.salePrice || a.originalPrice)));
        }
        if (filter === "RATING") {
